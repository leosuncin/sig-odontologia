...
IF diente = 0 THEN
	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.molarderecha = 1 INTO masC1;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.molarderecha = 2 INTO masC2;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.molarderecha = 3 INTO masC3;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.molarderecha = 4 INTO masCC;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.molarderecha = 5 INTO masNE;

   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.molarderecha = 1 INTO femC1;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.molarderecha = 2 INTO femC2;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.molarderecha = 3 INTO femC3;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.molarderecha = 4 INTO femCC;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.molarderecha = 5 INTO femNE;
...
ELSEIF diente = 1 THEN
	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.molarizquierda = 1 INTO masC1;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.molarizquierda = 2 INTO masC2;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.molarizquierda = 3 INTO masC3;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.molarizquierda = 4 INTO masCC;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.molarizquierda = 5 INTO masNE;

   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.molarizquierda = 1 INTO femC1;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.molarizquierda = 2 INTO femC2;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.molarizquierda = 3 INTO femC3;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.molarizquierda = 4 INTO femCC;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.molarizquierda = 5 INTO femNE;
...
ELSEIF diente = 2 THEN 
	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.caninaderecha = 1 INTO masC1;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.caninaderecha = 2 INTO masC2;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.caninaderecha = 3 INTO masC3;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.caninaderecha = 4 INTO masCC;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.caninaderecha = 5 INTO masNE;

   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.caninaderecha = 1 INTO femC1;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.caninaderecha = 2 INTO femC2;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.caninaderecha = 3 INTO femC3;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.caninaderecha = 4 INTO femCC;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.caninaderecha = 5 INTO femNE;
...
ELSEIF diente = 3 THEN
	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.caninaizquierda = 1 INTO masC1;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.caninaizquierda = 2 INTO masC2;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.caninaizquierda = 3 INTO masC3;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.caninaizquierda = 4 INTO masCC;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.caninaizquierda = 5 INTO masNE;

   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.caninaizquierda = 1 INTO femC1;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.caninaizquierda = 2 INTO femC2;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.caninaizquierda = 3 INTO femC3;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.caninaizquierda = 4 INTO femCC;
   	SELECT COUNT(*) FROM relacionessagitales, datosgenerales WHERE relacionessagitales.codexpediente = datosgenerales.codexpediente AND datosgenerales.fecharegistro between fecha_inicio AND fecha_fin AND datosgenerales.genero=sexo AND relacionessagitales.caninaizquierda = 5 INTO femNE;
