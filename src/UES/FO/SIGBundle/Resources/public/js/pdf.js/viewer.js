...
PDFJS.imageResourcesPath = '/bundles/sig/js/pdf.js/images/';
PDFJS.workerSrc = '/bundles/sig/js/pdf.js/pdf.worker.js';
PDFJS.cMapUrl = '/bundles/sig/js/pdf.js/cmaps/';
...
var TextLayerBuilder = function textLayerBuilder(options) {
    ...
    this.renderMatches = function textLayerBuilder_renderMatches(matches) {
        ...
        var selectedMatchIdx = (PDFFindController === null ? -1 : PDFFindController.selected.matchIdx);
